...
def home_view(request):
    """Root '/' -> dashboard if logged in, else login page."""
...
def dashboard_view(request):
    ...
    context = {
        ...
        "conversions": 0,
        "roi": 0.0,
        "funnel_labels": ["New", "Contacted", "Qualified", "Converted"],
...
def campaigns_view(request):
    ...
    """
    campaigns = []
    return render(request, "core/campaigns.html", {"campaigns": campaigns, "active": "campaigns"})
...
def leads_view(request):
    ...
    """
    context = {"new_count": 0, "qualified_count": 0, "converted_count": 0, "active": "leads"}
...
def ai_insights_view(request):
    ...
    TODO: hook this up to your AI scoring/prediction service and
    pass a list of recommendation dicts as `insights`.
    """
    insights = []
    return render(request, "core/ai_insights.html", {"insights": insights, "active": "ai"})
